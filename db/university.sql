...
CREATE TABLE `classrooms` (
  ...
  `week_day` enum('شنبه','یکشنبه','دوشنبه','سه شنبه','چهارشنبه') DEFAULT NULL,
  `time_period_id` bigint(20) UNSIGNED DEFAULT NULL,
  `status` enum('ثابت','چرخشی') DEFAULT NULL,
...
(2, 1, 1, 'شنبه', 2, 'ثابت', 2, 2, '2024-04-24 20:09:49', '2024-04-24 20:09:49', NULL, NULL),
(3, 1, 1, 'یکشنبه', 1, 'ثابت', 1, 2, '2024-04-24 20:09:49', '2024-04-24 20:09:49', NULL, NULL),
(4, 1, 1, 'یکشنبه', 2, 'چرخشی', 2, 2, '2024-04-24 20:09:49', '2024-04-24 20:09:49', NULL, NULL);
...
(1, 'رایانش تکاملی', '14056', 'کامپیوتر', '2024-04-24 20:06:29', '2024-04-24 20:06:29', NULL, NULL),
...
CREATE TABLE `presence_and_absences` (
  ...
  `term_id` bigint(20) UNSIGNED DEFAULT NULL,
  `classroom_id` bigint(20) UNSIGNED DEFAULT NULL,
  `status` enum('created','not_created','empty') NOT NULL,
  `date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, 2, 3, 'created', '2024-05-08'),
(3, 2, 3, 'created', '2024-05-09'),
(4, 2, 2, 'created', '2024-05-09'),
(5, 2, 1, 'created', '2024-05-09'),
(6, 2, 3, 'created', '2024-05-09'),
(7, 2, 3, 'created', '2024-05-09'),
(8, 2, 3, 'created', '2024-05-09'),
(9, 2, 3, 'created', '2024-05-09'),
(10, 2, 3, 'created', '2024-05-09'),
(11, 2, 3, 'created', '2024-05-09'),
(12, 2, 3, 'created', '2024-05-09'),
(13, 2, 2, 'created', '2024-05-09'),
(14, 2, 1, 'created', '2024-05-09'),
(15, 2, 3, 'created', '2024-05-09'),
(16, 2, 3, 'created', '2024-05-09'),
(17, 2, 3, 'created', '2024-05-09'),
(18, 2, 3, 'created', '2024-05-09'),
(19, 2, 3, 'created', '2024-05-09'),
(20, 2, 3, 'created', '2024-05-09'),
(21, 2, 3, 'created', '2024-05-09'),
(22, 2, 3, 'created', '2024-05-09'),
(23, 2, 3, 'created', '2024-05-09'),
(24, 2, 3, 'created', '2024-05-09'),
(25, 2, 3, 'not_created', '2024-05-09'),
(26, 2, 3, 'created', '2024-05-09'),
(27, 2, 3, 'created', '2024-05-09'),
(28, 2, 3, 'created', '2024-05-09'),
(29, 2, 3, 'created', '2024-05-09'),
(30, 2, 3, 'created', '2024-05-09'),
(31, 2, 3, 'created', '2024-05-09'),
(32, 2, 3, 'created', '2024-05-09'),
(33, 2, 3, 'created', '2024-05-09'),
(34, 2, 3, 'created', '2024-05-09'),
(35, 2, 3, 'created', '2024-05-09'),
(36, 2, 3, 'created', '2024-05-09'),
(37, 2, 3, 'created', '2024-05-09'),
(38, 2, 3, 'created', '2024-05-09');
